...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("선택: ");
        int repoChoice = Integer.parseInt(scanner.nextLine().trim());

        // Repository 생성 후 Service 에 주입!
    ...
    static void registerMember() {
        ...
        boolean result = service.register(newMember);
    ...
    static void printAllMembers() {
        ...
        for (int i = 0; i < members.size(); i++) {
            members.get(i).printSummary(i + 1);
        }
